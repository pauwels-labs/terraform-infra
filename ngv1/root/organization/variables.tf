...
variable "root_organisation_name" {
  description = "If this organisation is not root, set this to the name of the organisation that is in order to link this organisation's users to the infrastructure provider realm"
  type        = string
  nullable    = true
  default     = null
}
...
variable "is_root" {
  description = "Set to true if this organisation is a root organisation that hosts the infrastructure that other guest organisations use"
  type        = bool
  default     = false
}

variable "is_guest" {
  description = "Set to true if this organisation is a guest of a root; an organisation can be both root and guest if it both hosts infrastructure and deploys guest services onto it"
  type        = bool
  default     = false
}
