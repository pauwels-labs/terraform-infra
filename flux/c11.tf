...
resource "kubernetes_secret" "flux_infra_deploy_key_c11" {
  ...
  data = {
    identity       = tls_private_key.flux_infra_deploy_key[local.cluster_index[11]].private_key_pem
    "identity.pub" = tls_private_key.flux_infra_deploy_key[local.cluster_index[11]].public_key_pem
